...
const CourseDetails = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-gray-200 dark:bg-slate-600 rounded-lg shadow-md p-6 mb-6">
        <div className="flex justify-between items-center mb-4">
          <span className="capitalize bg-blue-900 text-blue-200 px-3 py-1 rounded">
            {course.difficulty}
          </span>
          <span className="text-gray-300">{course.totalDuration}</span>
        </div>
        <p className="text-gray-200 mb-4">{course.summary}</p>
      </div>

      <h2 className="text-2xl font-semibold mb-4 text-white">Course Chapters</h2>
      <div className="space-y-4">
        {course.chapters.map((chapter, index) => (
          <div key={chapter._id} className="bg-gray-200 dark:bg-slate-600 rounded-lg shadow-md p-6">
